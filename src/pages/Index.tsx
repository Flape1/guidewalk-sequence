    ...
    <div className="h-screen w-screen overflow-hidden bg-black">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10">
        ...
        <div className="flex justify-center items-end h-full">
          <div className="overflow-x-auto pb-4 px-2 w-full">
                ...
                >
                  <div className="w-24 sm:w-32 relative">
                    <img 
                      ...
                      alt={path.name}
                      className="w-full h-12 sm:h-16 object-cover rounded-lg shadow-lg" 
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent rounded-lg">
                      <div className="absolute bottom-0 left-0 right-0 p-1">
                        <h3 className="text-white text-xs font-medium text-center truncate">{path.name}</h3>
                      </div>
                    </div>
                  </div>
                </div>
